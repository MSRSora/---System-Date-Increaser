...
<!--笔者开发这个程序的起因，是在游玩一款名为《冥狱战术》的游戏时，发现墓穴中有一个每天只能领取一次的宝箱，领取后需等待约1天的倒计时，而后才能再次领取。为了快速获取奖励以达成全收集成就，因此开发了该程序。-->

## 使用方法 - Usage

1. 如果是Windows 11系统，右键点击菜单栏右下角的系统时间 - 调整日期和时间，**将“自动设置时间”选项关闭**。
